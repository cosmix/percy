...
export function activate(context: vscode.ExtensionContext) {
	...
	const openPercyInNewTab = async () => {
		...
		panel.iconPath = {
			light: vscode.Uri.joinPath(context.extensionUri, "assets", "icons", "prop_panel_light.png"),
			dark: vscode.Uri.joinPath(context.extensionUri, "assets", "icons", "prop_panel_dark.png"),
		}
