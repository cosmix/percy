# Archimedes and Model Context Protocol (MCP) Servers: Enhancing AI Capabilities
...
This document explains Model Context Protocol (MCP) servers, their capabilities, and how Archimedes can help build and use them.
...
Archimedes simplifies the building and use of MCP servers through its AI capabilities.

### Building MCP Servers

-   **Natural language understanding:** Instruct Archimedes in natural language to build an MCP server by describing its functionalities. Archimedes will interpret your instructions and generate the necessary code.
-   **Cloning and building servers:** Archimedes can clone existing MCP server repositories from GitHub and build them automatically.
-   **Configuration and dependency management:** Archimedes handles configuration files, environment variables, and dependencies.
-   **Troubleshooting and debugging:** Archimedes helps identify and resolve errors during development.

### Using MCP Servers

-   **Tool execution:** Archimedes seamlessly integrates with MCP servers, allowing you to execute their defined tools.
-   **Context-aware interactions:** Archimedes can intelligently suggest using relevant tools based on conversation context.
-   **Dynamic integrations:** Combine multiple MCP server capabilities for complex tasks. For example, Archimedes could use a GitHub server to get data and a Notion server to create a formatted report.
